...
<v-layout>
  <v-flex xs4>
    <panel title="Story Info">
      <v-text-field label="Title" v-model="story.title"></v-text-field>
      <v-text-field label="Quote" v-model="story.quote"></v-text-field>
    </panel>
  </v-flex>
  <v-flex>
    <panel title="Story Body" class="ml-2">
      <v-text-field label="Story" multi-line v-model="story.para"></v-text-field>
    </panel>
